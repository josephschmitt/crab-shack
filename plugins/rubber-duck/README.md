...
> **You:** /rubber-duck what if we replaced all the ice cream in the world with froyo? Wouldn't that be cheaper?
>
...
"/rubber-duck", "I'm just thinking out loud", "brainstorming here, don't act on it", "spitballing", "riff with me on this", "play devil's advocate". Claude stays in the mode until you clearly step out — "ok, actually build it", "for real this time", or "/rubber-duck off".
...
/plugin install rubber-duck@joes-crab-shack
```

### Claude.ai (web or desktop)

Download [`rubber-duck.zip`](https://github.com/josephschmitt/crab-shack/releases/latest/download/rubber-duck.zip) from the [latest release](https://github.com/josephschmitt/crab-shack/releases/latest), then in Claude click **+** → **Create skill** and upload the zip.
